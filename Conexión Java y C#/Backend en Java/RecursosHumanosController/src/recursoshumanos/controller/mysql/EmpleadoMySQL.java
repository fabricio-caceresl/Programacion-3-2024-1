...
public class EmpleadoMySQL implements EmpleadoDAO {
    ...
    public int insertar(Empleado empleado) {
        ...
        try {
            ...
            statement.setInt("_fidEmpleado", empleado.getArea().getId());
    ...
    public ArrayList<Empleado> listarTodos() {
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                empleado.setApellidoPaterno(resultSet.
                        getString("Apellido Paterno"));
                empleado.setGenero(resultSet.getString("Género").charAt(0));
                empleado.setFechaNacimiento(resultSet.
                        getDate("Fecha de Nacimiento"));
